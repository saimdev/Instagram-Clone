            ...
            <div class="col col-10 d-flex flex-column text-white py-5" style="padding-left: 7rem; padding-right:7rem">
                ...
                backdrop-filter: blur(25px) saturate(100%);">
                    <div class="col-6" style="padding: 0">
                        <img src="{{asset('/imgs/users/'.$username.'/'.$postpath.'.jpg')}}" alt="" width="100%" height="100%" style="border-radius: 0.5rem 0 0 0.5rem;">
                    </div>
                    <div class="col-6 d-flex flex-column py-1 px-4">
                        <div class="d-flex align-items-center justify-content-between mt-3">
                            <div class="d-flex align-items-center">
                                ...
                                @else
                                    <img src="{{asset('/imgs/users/'.$username.'.jpg')}}" alt="" style="clip-path:circle();" width="40px">
                                @endif
                                <div class="d-flex flex-column align-items-center" style="">
                                    <a href="/profile/{{$username}}" class="text-decoration-none text-white"><p class="" style="font-size: 0.9rem; margin-left:0.9rem;">{{$username}}</p></a> 
                        ...
                        @if ($postdata!=null)
                            ...
                            <div class="lowerpost d-flex flex-column container-fluid p-3 ">
                                <div class="operations d-flex align-items-center w-100">
                                    @if ($likescheck==1)
                                        <a href="/likepost/{{$username}}/{{$username}}/{{$postpath}}"><img class="operation-icon check-icon" src="{{asset('/imgs/logos/heart-red.svg')}}" alt=""></a>
                                    @else
                                        <a href="/likepost/{{$username}}/{{$username}}/{{$postpath}}"><img class="operation-icon check-icon" src="{{asset('/imgs/logos/heart.svg')}}" alt=""></a>
                                    @endif
                                ...
                                @foreach ($collection as $item)
                                    <form action="/commentonpost/{{$username}}/{{$item->post}}/{{$username}}" method="post" style="border: none;
                                    border-radius: none;
                                    background: none;
